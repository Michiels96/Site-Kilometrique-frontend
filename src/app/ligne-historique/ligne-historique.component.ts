...
export class LigneHistoriqueComponent implements OnInit, OnDestroy {
  ...
  constructor(private router: Router, private formBuilder: FormBuilder, private ligneService: LigneService, private vehiculeService: VehiculeService, private utilisateurService: UtilisateurService, private statistiqueService: StatistiqueService, private languageService: LanguageService, private translateService: TranslateService) { }
