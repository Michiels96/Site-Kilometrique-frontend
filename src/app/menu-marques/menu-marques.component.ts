...
export class MenuMarquesComponent implements OnInit, OnDestroy {
  ...
  constructor(private router: Router, private marqueService: MarqueService, private utilisateurService: UtilisateurService, private languageService: LanguageService, private translateService: TranslateService) { }
