...
export class HistoriqueDeNavigationComponent implements OnInit, OnDestroy {
  ...
  constructor(private ligneService: LigneService, private router: Router, private utilisateurService: UtilisateurService, private languageService: LanguageService, private translateService: TranslateService) { }
