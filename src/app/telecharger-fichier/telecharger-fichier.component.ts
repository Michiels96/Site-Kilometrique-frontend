...
export class TelechargerFichierComponent implements OnInit, OnDestroy {
  ...
  constructor(private formBuilder: FormBuilder, private utilisateurService: UtilisateurService, private downloadService: DownloadService, private languageService: LanguageService, private translateService: TranslateService) { }
