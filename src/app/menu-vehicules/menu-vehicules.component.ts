...
export class MenuVehiculesComponent implements OnInit, OnDestroy {
  ...
  constructor(private vehiculeService: VehiculeService, private router: Router, private utilisateurService: UtilisateurService, private languageService: LanguageService, private translateService: TranslateService) { }
